    ...
    bind(ev) {
        ...
        ev.on('contacts.update', (contacts) => {
            contacts.forEach(contact => {
                ...
                // Capture LID when Baileys provides it
                if (contact.lid) {
                    this.contacts[contact.id].lid = contact.lid;
                    // Also index the reverse entry so LID→JID lookups work
                    this.contacts[contact.lid] = {
                        ...(this.contacts[contact.lid] || {}),
                        id:  contact.lid,
                        jid: contact.id,
                    };
